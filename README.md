...
Fully automated `Ubuntu|Arch|Red Hat (wip)` development environment that is easy to set up and maintain for my use.
...
```bash
bash -c "$(curl -fsSL https://raw.githubusercontent.com/drkchico/dotfiles/main/bin/dotfiles)"
```

If you want to run only a specific role, you can specify the following bash command:
```bash
curl -fsSL https://raw.githubusercontent.com/drkchico/dotfiles/main/bin/dotfiles | bash -s -- --tags comma,seperated,tags
```
